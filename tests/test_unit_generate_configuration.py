...
class TestConfig(unittest.TestCase):
    ...
    def test_handling_sources(self, mock_fetch_file, mock_check_sum):
        ...
        mock_fetch_file.assert_called_with('http://somehost.com/file.zip', 'target/file.zip')
        mock_check_sum.assert_called_with('target/file.zip', 'e9013fc202c87be48e3b302df10efc4b', 'md5')
    ...
    def test_handling_sources_with_sha1(self, mock_fetch_file, mock_check_sum):
        ...
        mock_fetch_file.assert_called_with('http://somehost.com/file.zip', 'target/file.zip')
        mock_check_sum.assert_called_with('target/file.zip', '105bfe02a86ba69be5506cd559a54c4b252fb132', 'sha1')
    ...
    def test_handling_sources_with_sha256(self, mock_fetch_file, mock_check_sum):
        ...
        mock_fetch_file.assert_called_with('http://somehost.com/file.zip', 'target/file.zip')
        mock_check_sum.assert_called_with('target/file.zip', '9912afca5a08e9e05174c5fbb7a9a1510283d5952f90796c6a3e8bc78217e2fb', 'sha256')
