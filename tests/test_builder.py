        ...
        [
            ...
            call(
                [
                    ...
                    "buildContainer",
                    "--kwargs",
                    "{'src': 'https://something.redhat.com/git/containers/openjdk#c5a0731b558c8a247dd7f85b5f54462cd5b68b23', 'target': 'some-branch-containers-candidate', 'opts': {'scratch': True, 'git_branch': 'some-branch', 'yum_repourls': []}}",
                ],
                stderr=-1,
                stdout=-1,
                check=True,
...
def test_osbs_builder_run_brew_target_defined_in_descriptor(mocker):
    ...
    run.assert_called_with(
        [
            ...
            "buildContainer",
            "--kwargs",
            "{'src': 'https://something.redhat.com/git/containers/openjdk#c5a0731b558c8a247dd7f85b5f54462cd5b68b23', 'target': 'some-target', 'opts': {'scratch': True, 'git_branch': 'some-branch', 'yum_repourls': []}}",
        ],
        stderr=-1,
        stdout=-1,
        check=True,
